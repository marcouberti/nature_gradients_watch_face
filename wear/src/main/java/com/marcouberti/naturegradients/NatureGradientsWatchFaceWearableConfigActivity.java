...
/**
 * The watch-side config activity for {@link NatureGradientsFace}, which allows for setting the
 * background color.
 */
public class NatureGradientsWatchFaceWearableConfigActivity extends Activity implements
    ...
    public void onClick(WearableListView.ViewHolder viewHolder) {
        ...
        updateConfigDataItem(GradientsUtils.getColorID(colorItemViewHolder.mColorItem.getColorName()));
        finish();
    }
    ...
    private static class ColorItem extends LinearLayout implements
        ...
        private void setColor(String cName) {
            ...
            colorName = cName;
            mColor.gradients = GradientsUtils.getGradients(getContext(), cName);
        }
