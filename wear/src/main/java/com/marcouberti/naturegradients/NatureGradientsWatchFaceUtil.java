...
public final class NatureGradientsWatchFaceUtil {
    private static final String TAG = "DigitalWatchFaceUtil";

    /**
     * The {@link DataMap} key for {@link NatureGradientsFace} background color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_BACKGROUND_COLOR = "BACKGROUND_COLOR";

    /**
     * The {@link DataMap} key for {@link NatureGradientsFace} hour digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_HOURS_COLOR = "HOURS_COLOR";

    /**
     * The {@link DataMap} key for {@link NatureGradientsFace} minute digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    public static final String KEY_MINUTES_COLOR = "MINUTES_COLOR";

    /**
     * The {@link DataMap} key for {@link NatureGradientsFace} second digits color name.
     * The color name must be a {@link String} recognized by {@link Color#parseColor}.
     */
    ...
    /**
     * Asynchronously fetches the current config {@link DataMap} for {@link NatureGradientsFace}
                ...
                new ResultCallback<NodeApi.GetLocalNodeResult>() {
                    ...
                    public void onResult(NodeApi.GetLocalNodeResult getLocalNodeResult) {
                        ...
                        Uri uri = new Uri.Builder()
                                .scheme("wear")
                                .path(NatureGradientsWatchFaceUtil.PATH_WITH_FEATURE)
                                .authority(localNode)
                                .build();
    ...
    public static void overwriteKeysInConfigDataMap(final GoogleApiClient googleApiClient,
        ...
        NatureGradientsWatchFaceUtil.fetchConfigDataMap(googleApiClient,
                new FetchConfigDataMapCallback() {
                    ...
                    public void onConfigDataMapFetched(DataMap currentConfig) {
                        ...
                        NatureGradientsWatchFaceUtil.putConfigDataItem(googleApiClient, overwrittenConfig);
                    }
                }
        );
    }
    ...
    private NatureGradientsWatchFaceUtil() { }
}
