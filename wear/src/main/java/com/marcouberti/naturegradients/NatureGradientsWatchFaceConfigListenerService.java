...
/**
 * A {@link WearableListenerService} listening for {@link NatureGradientsFace} config messages
 * and updating the config {@link com.google.android.gms.wearable.DataItem} accordingly.
 */
public class NatureGradientsWatchFaceConfigListenerService extends WearableListenerService
    ...
    public void onMessageReceived(MessageEvent messageEvent) {
        if (!messageEvent.getPath().equals(NatureGradientsWatchFaceUtil.PATH_WITH_FEATURE)) {
            return;
        }
